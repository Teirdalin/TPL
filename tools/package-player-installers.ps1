...
$manual=Join-Path $OutputDirectory 'TPL-0.1.2-Manual.zip'
$installer=Join-Path $OutputDirectory 'TPL-0.1.2-Installer.exe'
...
$payload=@(
    'TPL.dll','TPL\versions\0.1.2\TPL.Runtime.dll','TPL\versions\0.1.2\TPL.Update.ps1','TPL\versions\0.1.2\runtime.json',
