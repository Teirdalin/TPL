...
$manual=Join-Path $OutputDirectory 'TPL-0.1.5-Manual.zip'
$installer=Join-Path $OutputDirectory 'TPL-0.1.5-Installer.exe'
...
$payload=@(
    'TPL.dll','TPL\versions\0.1.5\TPL.Runtime.dll','TPL\versions\0.1.5\TPL.Update.ps1','TPL\versions\0.1.5\runtime.json',
