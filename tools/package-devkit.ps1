...
$paths=@(
    ...
    'PLUGIN_API_PERMISSION.md','LICENSE','Licenses\JDL-1.txt','tools\New-TPLPlugin.ps1',
...
[IO.File]::WriteAllText(($archive+'.sha256'),(Get-FileHash -LiteralPath $archive).Hash.ToLowerInvariant())
