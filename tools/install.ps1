...
$payload=@(
    'TPL.dll','TPL\versions\0.1.0\TPL.Runtime.dll','TPL\versions\0.1.0\TPL.Update.ps1',
    'TPL\versions\0.1.0\runtime.json','TPL\current.txt','TPL\automatic-updates.txt'
)
...
$versionSource=Join-Path $PayloadDir 'TPL\versions\0.1.0'
$versionTarget=Join-Path $GameDir 'TPL\versions\0.1.0'
