...
$payload=@(
    'TPL.dll','TPL\versions\0.1.5\TPL.Runtime.dll','TPL\versions\0.1.5\TPL.Update.ps1',
    'TPL\versions\0.1.5\runtime.json','TPL\current.txt','TPL\automatic-updates.txt'
)
...
$versionSource=Join-Path $PayloadDir 'TPL\versions\0.1.5'
$versionTarget=Join-Path $GameDir 'TPL\versions\0.1.5'
...
[IO.File]::WriteAllText($tempCurrent,'0.1.5')
